...
>(({ className, children, enableScrollArea = true, contentScrollable = false, fixedFooter = false, ...props }, ref) => (
  <DialogPortal>
    <DialogOverlay />
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        fixedFooter ? "flex flex-col" : "",
        contentScrollable && !fixedFooter ? "overflow-y-auto" : "overflow-hidden",
        className
      )}
      {...props}
    >
      {fixedFooter ? (
        ...
        <ScrollArea className="max-h-[calc(90vh-40px)] w-full pr-4 overflow-auto">
          <div className="pr-2 pb-6">
            {children}
          </div>
        </ScrollArea>
